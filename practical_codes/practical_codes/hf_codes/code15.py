...
embedding_text = model.encode(text, batch_size=12, max_length=8192)['dense_vecs']
embedding_query = model.encode(query, batch_size=12, max_length=8192)['dense_vecs']

sim = cosine_similarity([embedding_query], [embedding_text])[0][0]
